...
if __name__ == '__main__':
    ...
    params['passed_data'] = {'pv_power_forecast':pv_power_forecast,'load_power_forecast':load_power_forecast,
                             ...
                             'operating_hours_of_each_deferrable_load':operating_hours_of_each_deferrable_load,'alpha':alpha,'beta':beta}
    ...
    opt_res_dayahead = opt.perform_naive_mpc_optim(
        ...
        soc_init=soc_init, soc_final=soc_final, def_total_hours=operating_hours_of_each_deferrable_load)
